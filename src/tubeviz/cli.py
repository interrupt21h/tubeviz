...
def build_parser() -> argparse.ArgumentParser:
    ...
    analyze.add_argument("--effect-density", type=float, default=0.65, help="How often strong/special effects are scheduled; 1 historical density, >1 more frequent punctuation, up to ~2.5")
    analyze.add_argument("--temporal-persistence", type=float, default=0.75, help="Cross-shot temporal inheritance budget; 0 always resets history, >1 more related cuts inherit trails/feedback")
    analyze.add_argument("--hero-frequency", type=float, default=0.90, help="Frequency multiplier for sparse hero treatments; 1 ~one per 48 seconds, 2 ~twice as often")
    ...
    analyze.add_argument("--composition-diversity", type=float, default=0.70, help="Variety of multi-source grammars; >1 admits animated split, mosaic-flow and source-swap modes")
    ...
    serve.add_argument("--effect-density", type=float, default=0.65, help="Strong/special effect scheduling density when replanning")
    serve.add_argument("--temporal-persistence", type=float, default=0.75, help="Cross-shot temporal-history inheritance when replanning")
    serve.add_argument("--hero-frequency", type=float, default=0.90, help="Hero-treatment frequency multiplier when replanning")
    ...
    serve.add_argument("--composition-diversity", type=float, default=0.70, help="Multi-source composition grammar diversity when replanning")
