...
def _blend(base: SectionAIDirection, proposed: SectionAIDirection, strength: float) -> SectionAIDirection:
    ...
    return base.model_copy(update={
        ...
        "effect_density": mix(base.effect_density, proposed.effect_density),
        "temporal_persistence": mix(base.temporal_persistence, proposed.temporal_persistence),
        "composition_diversity": mix(base.composition_diversity, proposed.composition_diversity),
        "hero_frequency": mix(base.hero_frequency, proposed.hero_frequency),
        "preferred_effects": proposed.preferred_effects or base.preferred_effects,
        "preferred_composition": proposed.preferred_composition or base.preferred_composition,
